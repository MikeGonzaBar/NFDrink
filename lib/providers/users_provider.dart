...
class UsersProvider with ChangeNotifier {
  ...
  Future<List> getFilteredProductsByOwner(
      dynamic adminData, String start, String end) async {
    try {
      List<dynamic> newProductList = [];
  ...
  dynamic getFilteredData(dynamic productData, String start, String end) async {
    ...
    dynamic newStats = await getFilteredScannedStats(filteredScans);
  ...
  dynamic getFilteredScannedStats(List<dynamic> scans) async {
    dynamic stats = {};
